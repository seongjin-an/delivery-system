...
dependencies {
    ...
    // 아래 넷은 compileOnly 다. GlobalExceptionHandler, 컨슈머 에러 핸들러, 배차 공용 코드를
    // 컴파일하려면 필요한데, 여기서 api 로 걸면 카프카도 레디스도 안 쓰는 rider-simulator 까지
    // 전부 끌고 오게 된다. 자동설정에 @ConditionalOnClass 를 걸어둔 이유가 이거다 —
