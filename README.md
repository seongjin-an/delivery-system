...
| **RabbitMQ** | 등기우편 | 배차 제안 — 특정 한 명에게, 10초 안에, 안 받으면 반송 | per-message TTL + DLX 를 스케줄러 테이블로 손수 재구현하게 된다 |
...
위치 스트림을 래빗엠큐로 보내본 결과는 [`.reference/tech-choice.md`](.reference/tech-choice.md) 2절에 있다.
