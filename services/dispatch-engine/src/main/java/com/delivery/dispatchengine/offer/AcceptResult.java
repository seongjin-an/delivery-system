...
/**
 * 수락 Lua 의 반환값. 기능 정의서 DE-04 의 표 그대로다.
 *
...
public enum AcceptResult {
    ...
    AcceptResult(long code, ErrorCode errorCode) {
        this.code = code;
    ...
    static AcceptResult of(Long returned) {
        if (returned == null) {
        ...
        throw new IllegalStateException("수락 스크립트가 모르는 값을 돌려줬다: " + returned);
    }
}
